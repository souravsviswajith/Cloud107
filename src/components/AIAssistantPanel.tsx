...
export function AIAssistantPanel() {
  ...
  const [messages, setMessages] = useState<{ role: 'user' | 'assistant'; text: string }[]>([
    {
      role: 'assistant',
      text: `Hi! I am your Workspace AI. I can see you are currently in ${activeMode} mode on ${activeVm?.name || 'the dashboard'}. How can I help you optimize your session today?`,
    },
  ]);
  ...
  const handleSend = (e?: React.FormEvent) => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...
        {
          role: 'assistant',
          text: 'I have analyzed your request. As a frontend prototype, I can read your intent but backend execution is mocked. Imagine me seamlessly orchestrating your cloud resources!',
        },
      ]);
      addNotification({
