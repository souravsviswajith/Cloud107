...
import { Search, ArrowLeft, Terminal, LayoutDashboard, Code2, Paintbrush, Database, Box, StickyNote, Globe, Loader2 } from 'lucide-react';
...
const IconMap: Record<string, React.ElementType> = {
  Code2, LayoutDashboard, Box, Paintbrush, Terminal, Database, StickyNote, Globe
};
      ...
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-semibold text-2xl tracking-tight text-white">Application Library</h1>
              ...
              >
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-colors ${
                  ...
                  <IconComponent size={32} className={`transition-colors ${
                    isAvailable ? "text-neutral-400 group-hover:text-blue-400" : "text-neutral-600"
                  }`} />
                </div>
                <div className="text-center relative w-full flex flex-col items-center">
                  <h3 className={`font-medium text-sm ${isAvailable ? "text-neutral-200" : "text-neutral-400"}`}>{app.name}</h3>
                  {isAvailable ? (
